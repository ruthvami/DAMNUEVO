...
public class Lloro extends Aus {
    ...
    public Lloro(String nom,int edat,String estat,String dataNaixement,String bec,
            boolean vola,String origen,boolean parla) throws ExceptionNomBuit, ExceptionEdatNegativa{
