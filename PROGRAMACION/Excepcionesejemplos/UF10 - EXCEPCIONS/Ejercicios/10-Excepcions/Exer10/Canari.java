...
public class Canari extends Aus {
    ...
    public Canari(String nom,int edat,String estat,String dataNaixement,String bec,boolean vola,String color,
            boolean canta) throws ExceptionNomBuit, ExceptionEdatNegativa{
