...
public class Satellit extends Astre {
    ...
    private ArrayList<Planeta> obj = new ArrayList<Planeta>();
    ...
    public Satellit(String nom, double radi, int rotacio, double massa, double temperatura, double gravetat, double distanciapl, double orbitapl, ArrayList obj) {
        super(nom, radi, rotacio, massa, temperatura, gravetat);
        this.distanciapl = distanciapl;
        this.orbitapl = orbitapl;
    }
